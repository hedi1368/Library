...
<body class="navbar-fixed sidebar-nav fixed-nav">
    ...
    <main class="main">
        ...
        <div class="container-fluid">
            <h2 style="margin-top: 50px">لیست کتاب‌های به امانت گرفته شده توسط شما:</h2>
            ...
            <div class="animated fadeIn">
                ...
                <div class="row" style="margin-bottom: 10px">
                    ...
                    @foreach ($borrowedBooks as $book)
                        <div class="col-lg-2 col-sm-6 " style="margin: 15px !important">
                            <div class="portfolio-item"  >
                                ...
                                <div class="portfolio-caption" dir="rtl" style="height: 250px;overflow: auto;">
                                    ...
                                    <div style="float: right"><b>خلاصه کتاب :</b><br> {{ $book->description }}</div>
                                    <br><br>
                                ...
                                <div class="portfolio-caption" dir="rtl">
                                    ...
                                    @if ($book->pdf_file)
                                        <a class="pdf" href="{{ asset('storage/' . $book->pdf_file) }}"
                                            ...
                                            PDF</a>
                                    @else
                                        <span class="btn">فایل PDF موجود نیست</span>
                                    @endif
                                    <form action="{{ route('books.return', ['id' => $book->id]) }}" method="post"
                                        style="margin-top: 20px">
                                        @csrf
                                        @method('put')
                                        <button type="submit" class="btn btn-dark">پس دادن کتاب</button>
                                    </form>
                                </div>
